...
const SuggestedForYou = dynamic(() => import('@/components/shared/SuggestedForYou'), { ssr: false });
...
export default function ExplorePage() {
  ...
  const totalVisitors = users.length * 47;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 space-y-16">
      ...
      {/* ═══════════════════════════════════════════════════════════
         ★ SUGGESTED FOR YOU — Main follow funnel
         ═══════════════════════════════════════════════════════════ */}
      <div className="max-w-2xl mx-auto w-full">
        <SuggestedForYou limit={8} />
      </div>
